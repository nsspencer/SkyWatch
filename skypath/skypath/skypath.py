...
class SkyPath(KinematicCreationMixin):
    ...
    def __init__(self, coordinate_frame: Union[SkyCoord, BaseCoordinateFrame, CoordinateInterpolator, 'SkyPath']) -> None:
    ...
    def state_at(self, time: Time, frame: str = 'itrs', bounds_check:bool = True) -> 'SkyPath':
